...
class Query(graphene.ObjectType):
    ...
    def resolve_users(self, info, limit=None):
        return [
                   User(id="1", username="Uday", created_at=datetime.now()),
                   User(id="2", username="Ashutosh", created_at=datetime.now()),
                   User(id="3", username="Rahul", created_at=datetime.now()),
                   User(id="4", username="Palash", created_at=datetime.now())
               ][:limit]
